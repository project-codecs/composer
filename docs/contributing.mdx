...
title: Contributing
---
Contribution should be as easy as possible for everyone but there are a few things to consider when doing so.
...
- Issue reports should be **clear**, **concise** and **reproducible**. Check to see if your issue has already been resolved in the [current](https://github.com/project-codecs/composer) branch or already reported in Composer''' [GitHub Issue Tracker](https://github.com/project-codecs/composer/issues).
- Pull Requests must adhere to the project's [coding style guidelines](style).
...
* Please **do not** use the issue tracker for personal support requests (you
  can ask well-formed questions in adequate channels on the [Fabric Discord](https://discord.gg/v6v4pMv) or on the [Project Codex Discord](/* TODO */)).
...
> ```java
> BindManager.whileHeld(KEY_BINDING, BindManager.At.START_CLIENT, () -> {})
> // code sample
> ```
>
> Any other information you want to share that is relevant to the issue being reported. This might include the lines of code that you have identified as causing the bug,
...
Please adhere to the coding conventions used throughout a project (indentation, accurate comments, etc.) and any other requirements (such as test coverage). Please review the [Project Codex Coding Style Guide](style).
...
1. Go to the [Releases page on Github](https://github.com/project-codecs/composer/releases)
...
[This](https://moddedmc.wiki/en/composer-reloaded/latest) wiki.
...
- LilBroCodes
  - GitHub: [@LilBroCodes](https://github.com/LilBroCodes)
  - Discord: lilbrocodes

<br/><br/>
*Contributing guidelines based on [Cardinal Components'](https://github.com/ladysnake/cardinal-components-api/blob/main/CONTRIBUTING.md)* <br/>
*CCA's contributing are guidelines based on [ChaiJS'](https://github.com/chaijs/chai/blob/master/CONTRIBUTING.md)*