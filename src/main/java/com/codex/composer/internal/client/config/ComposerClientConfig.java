...
public class ComposerClientConfig extends Config {
    public ComposerClientConfig() {
        super(Composer.identify("config"));
    }

    public static ComposerClientConfig INSTANCE;
    ...
    public static void initialize() {
        INSTANCE = ConfigApiJava.registerAndLoadConfig(ComposerClientConfig::new, RegisterType.CLIENT);
    }
